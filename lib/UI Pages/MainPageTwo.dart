...
class _MainPageTwoState extends State<MainPageTwo> {
  ...
  void converter() {
    double  fahrenheit= double.tryParse(tempController.text) ?? 0.0;
    double celsius = (fahrenheit -32)* 5/9 ;
    setState(() {
      result = celsius.toStringAsFixed(2);
    });
  }
  @override
                  ...
                  child: Padding(
                    ...
                    child: Center(
                      child: Card(
                        ...
                        child: Center(
                            child: Text(
                              "Temperature is $result Degree Celsius",
                              style: GoogleFonts.signikaNegative(
                                  fontSize: 18, color: Colors.deepPurple.shade600),
                            )),
                      ),
                    ),
                  ),
